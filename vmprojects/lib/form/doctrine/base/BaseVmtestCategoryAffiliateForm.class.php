...
/**
 * VmtestCategoryAffiliate form base class.
 *
 * @method VmtestCategoryAffiliate getObject() Returns the current form's model object
 *
 * @package    vmtest
 * @subpackage form
 ...
 */
abstract class BaseVmtestCategoryAffiliateForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vmtest_category_affiliate[%s]');
  ...
  {
    return 'VmtestCategoryAffiliate';
  }
