...
/**
 * VmtestJob filter form base class.
 *
 * @package    vmtest
 * @subpackage filter
 ...
 */
abstract class BaseVmtestJobFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'category_id'  => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('VmtestCategory'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'category_id'  => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('VmtestCategory'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('vmtest_job_filters[%s]');
